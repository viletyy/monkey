 ...
 * @LastEditors: viletyy
 * @LastEditTime: 2021-05-20 11:03:28
 * @FilePath: /monkey/views/admin/news/new.tpl
-->
<nav class="breadcrumb" aria-label="breadcrumbs">
  <ul>
    ...
    <li class="is-active"><a aria-current="page">添加资讯</a></li>
  </ul>
</nav>
<div class="content box is-medium">
  <div class="card no-shadow">
    <div class="card-body">
      <form enctype="multipart/form-data" action="{{urlfor "admin.News.Create"}}" method="post">
        {{ .xsrfdata }}
        <div class="field">
        ...
        <button class="button is-info" type="submit">添加资讯</button>
