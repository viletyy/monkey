 ...
 * @LastEditors: viletyy
 * @LastEditTime: 2021-05-08 16:58:03
 * @FilePath: /monkey/views/admin/banner/new.tpl
-->
<nav class="breadcrumb" aria-label="breadcrumbs">
  <ul>
    ...
    <li class="is-active"><a aria-current="page">添加Banner</a></li>
  </ul>
</nav>
<div class="content box is-medium">
  <div class="card no-shadow">
    <div class="card-body">
      <form enctype="multipart/form-data" action="{{urlfor "admin.Banner.Create"}}" method="post">
        {{ .xsrfdata }}
        <div class="field">
